class Post{
    ...
    displayWithImage(user){
        return `<div id="centermain" class="col-12 mt-5 post">
                    <div id="cardpost" class="card article">
                        ...
                        <div class="card-body">
                            ...
                            <i class="fas fa-trash-alt removepost ${(user.userId == this.userId || user.isAdmin)?"":"disable"}" data-id="${this.id}"></i>
                        </div>
                    ...
                    <div>
                        <button id="commenter" class="btn btn-primary addcomment" type="submit" data-id="${this.id}">Répondre</button>
                    </div>
                </div>`
    }
